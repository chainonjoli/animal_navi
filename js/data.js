// ============================================================
// 動物キャラナビ — データベース
// 12のアニマル気質60キャラクター + 相性詳細 + 役割分析 + 推し活テキスト
// ============================================================
...
// ---- 60キャラクター個別解説 ----
// desc: そのキャラ固有の個性 / oshiHint: 推しがこのキャラだったときの見どころ
const CHAR_DETAILS = {
  1:  { desc: 'スピード勝負のチータの中では珍しい持久型。一度決めたゴールに向かって、息切れせずに走り続けられる人。', oshiHint: '長いスパンで夢を追いかける推し。5年後、10年後の姿まで見届けたくなる。' },
  2:  { desc: '誰とでもすっと距離を縮められる、天性の社交家。初対面でも「前から知ってた気がする」と思わせる安心感がある。', oshiHint: '共演者みんなに愛される推し。現場の空気が柔らかいのはこの人のおかげ。' },
  3:  { desc: 'じっとしていられない生粋の行動派。思いついた瞬間に体が動いていて、そのフットワークが周りを巻き込んでいく。', oshiHint: '次から次へ新しいことを始める推し。目が離せない忙しさも含めて楽しい。' },
  4:  { desc: 'のんびり屋が多い子守熊の中で、腰の軽さはピカイチ。頼まれごとに「いいよ」と即答できる気持ちのいい人。', oshiHint: '仕事を選ばずなんでも全力の推し。意外な現場に現れるサプライズが多い。' },
  5:  { desc: '困っている人を放っておけない、姉御肌・兄貴肌。美意識の高さと面倒見の良さを両立している貴重なタイプ。', oshiHint: '後輩からの「慕われエピソード」が尽きない推し。人望が透けて見える。' },
  6:  { desc: '情の深さは60キャラ随一。身内と認めた相手にはとことん愛情を注ぎ、絶対に見捨てない親分気質。', oshiHint: 'メンバー愛が行動に出る推し。さりげないフォローを見つけたら勝ち。' },
  7:  { desc: '思い立ったら即スタート、瞬発力の塊。迷っている時間がもったいないと考える、清々しいほどの直球型。', oshiHint: '挑戦の瞬間がいちばん輝く推し。初披露・初挑戦は絶対に見逃せない。' },
  8:  { desc: '所作や言葉選びが洗練された、上品な社交家。場数を踏んで磨かれた大人の余裕で、どんな場面もそつなくこなす。', oshiHint: 'トーク番組での立ち回りが美しい推し。「育ちの良さ」がにじむ瞬間に注目。' },
  9:  { desc: '見ている夢のスケールが大きい野心家。「そんなの無理だよ」と言われるくらいの目標こそ燃えるタイプ。', oshiHint: '大きな夢を公言する推し。有言実行の過程を一緒に追いかけるのが醍醐味。' },
  10: { desc: '包容力のかたまり。相手の変化にすぐ気づいて、そっと手を差し伸べる。いるだけで場が安心する存在。', oshiHint: 'メンバーのお世話係になりがちな推し。優しさが画面越しでも伝わってくる。' },
  11: { desc: '嘘やお世辞が言えない、まっすぐな心の持ち主。その正直さが信頼となって、長く深い関係を築いていく。', oshiHint: 'コメントに嘘がない推し。本音がぽろっと出る瞬間が最高に尊い。' },
  12: { desc: '努力家なのに、なぜか憎めない愛嬌の持ち主。気づけば周りに人が集まっている、天然の求心力がある。', oshiHint: 'ファンにも共演者にも愛される推し。人気の理由が「人柄」なのが誇らしい。' },
  13: { desc: '単独行動を好むのに、性格は底抜けに明るい珍しい狼。ひとりの時間で充電して、みんなの前では太陽になる。', oshiHint: 'ソロでもグループでも輝く推し。オンオフの切り替えの鮮やかさに注目。' },
  14: { desc: '仲間は大事、でも意見は曲げない。群れの中で我が道を行く、芯の強さと寂しがり屋が同居した複雑で魅力的な人。', oshiHint: '「みんなと同じ」を選ばない推し。時々見せる甘えん坊な一面とのギャップが沼。' },
  15: { desc: '落ち着きと遊び心のバランスが絶妙。ふざけるときは全力、締めるときはきっちり。周囲の信頼が厚い。', oshiHint: 'バラエティと本業の顔が全然違う推し。切り替わる瞬間を目撃してほしい。' },
  16: { desc: '究極のマイペース。周りがどれだけ騒がしくても、自分のリズムを崩さない。その安定感が周囲の癒しになる。', oshiHint: '何があっても動じない推し。ゆったりした佇まいそのものがヒーリング。' },
  17: { desc: '柔らかい物腰の奥に、鋼の意志を隠し持つ。一度「やる」と決めたことは、静かに、でも絶対にやり遂げる。', oshiHint: '穏やかに見えて実はいちばん頑固な推し。ストイックな裏側を知ると株が爆上がり。' },
  18: { desc: '繊細なアンテナを持つ努力家。人の気持ちの機微に敏感で、細やかな気配りが自然にできる。', oshiHint: 'ファンの小さな声まで拾ってくれる推し。「気づいてくれた」体験が起きやすい。' },
  19: { desc: '自由を愛する旅人気質。決まった枠に収まらず、常に新しい景色を探している。その背中がなにより雄弁。', oshiHint: '活動の幅がどんどん広がる推し。予想外の場所で見つける楽しみがある。' },
  20: { desc: '口数は少ないけれど、誰よりも深く聞いている人。静けさの中にある観察眼と思いやりが持ち味。', oshiHint: '多くを語らない推し。だからこそ、ふと漏れる一言の重みが違う。' },
  21: { desc: '天才肌なのに地に足がついている、レアなペガサス。ひらめきを現実に落とし込む力を持っている。', oshiHint: '天才性と安定感を両立する推し。「なんでもできる人」の凄みを味わえる。' },
  22: { desc: 'スケールの大きい自由人。常識の枠を軽々と飛び越えて、誰も見たことのない景色へ向かっていく。', oshiHint: '規格外のスケールで動く推し。「今度は何をやるの！？」が日常になる。' },
  23: { desc: '天真爛漫で人懐っこい、みんなの弟・妹的存在。裏表のない無邪気さが、周りの警戒心を溶かしていく。', oshiHint: '笑顔の破壊力が凄まじい推し。あどけなさと大人の顔のギャップに注意。' },
  24: { desc: '独創性のかたまり。人と同じことをするのが苦手で、常に「自分にしかできない表現」を探し続けている。', oshiHint: 'こだわりが細部に宿る推し。作品の隅々まで観察すると発見が尽きない。' },
  25: { desc: '物腰の柔らかい職人。ガツガツしないのに、気づけば確かな結果を残している。静かな実力者。', oshiHint: '派手さより確かさの推し。じわじわ評価が上がっていく過程が誇らしい。' },
  26: { desc: '一度始めたことを途中で投げ出さない粘り強さが武器。コツコツ積み上げた努力は、必ず花開く。', oshiHint: '下積み時代の話に泣かされる推し。積み重ねてきた時間ごと愛おしくなる。' },
  27: { desc: 'ジェットコースターのような人生を、むしろ楽しんでいる豪傑。浮き沈みさえエネルギーに変える。', oshiHint: 'ドラマチックな展開がついてまわる推し。どんな局面も見届けたくなる。' },
  28: { desc: '生まれながらの気品と華の持ち主。何気ない仕草まで絵になる、優雅さのプロフェッショナル。', oshiHint: '存在そのものがビジュアル担当の推し。静止画でも動画でも隙がない。' },
  29: { desc: '現状維持が苦手な挑戦者。安定した場所からあえて飛び出して、新しい自分を更新し続ける。', oshiHint: '常に新境地へ向かう推し。挑戦を発表する瞬間の顔が最高にいい。' },
  30: { desc: 'どんな環境でもすっと馴染める適応力の持ち主。一匹狼の自立心と柔軟さを併せ持つバランス型。', oshiHint: 'どの現場でも自然体の推し。アウェーでも実力を発揮する姿が頼もしい。' },
  31: { desc: '静かな統率力を持つ努力家。声を張り上げなくても、背中と実績でチームを引っ張っていく。', oshiHint: 'いつの間にか座長になっている推し。任される理由が画面から伝わってくる。' },
  32: { desc: '可憐な見た目に反して、中身は堅実なしっかり者。計画を立てて着実に進む、頼れる現実派。', oshiHint: '甘えられるのに自立している推し。セルフプロデュース力の高さに注目。' },
  33: { desc: 'エネルギッシュに動き回る、パワフルなコアラ。のんびり屋に見えて、実は誰よりも働き者。', oshiHint: 'スケジュールが心配になるほど働く推し。休んでいる姿を見ると安心する。' },
  34: { desc: '気分の波はあるけれど、それも含めて愛される人。ノッているときの爆発力は誰にも真似できない。', oshiHint: '調子がいい日の推しは手がつけられない面白さ。ムラっ気ごと推せる。' },
  35: { desc: '「頼りにしてる」の一言で何倍も頑張れる世話焼きさん。人の役に立てることが、いちばんの喜び。', oshiHint: 'メンバーに頼られると張り切る推し。信頼されている場面を集めたくなる。' },
  36: { desc: '一匹狼なのに、なぜか周りから好かれてしまう人徳の持ち主。独立心と愛嬌の絶妙なバランスが魅力。', oshiHint: '媚びないのに愛される推し。共演者が自然と褒めだすのを何度も見るはず。' },
  37: { desc: '目標を定めたら脇目も振らず一直線。その突進力と集中力は、見ている人の心まで熱くする。', oshiHint: '目標への一途さが眩しい推し。宣言から達成までの直線距離が最短。' },
  38: { desc: '人を惹きつける華やかさと、甘え上手な愛嬌を兼ね備える。場の主役に自然と収まっていく人。', oshiHint: '登場した瞬間に空気が変わる推し。華があるとはこの人のこと。' },
  39: { desc: '胸の中にいつも夢とロマンを抱えている理想主義者。現実的な計算力もあるから、夢で終わらせない。', oshiHint: '語る夢がいちいちロマンチックな推し。インタビュー記事は全部保存推奨。' },
  40: { desc: '尽くすことに喜びを感じる献身タイプ。相手が喜ぶ顔を思い浮かべながら、先回りして動ける人。', oshiHint: 'ファンサービスの鬼な推し。「そこまでしてくれるの？」が通常運転。' },
  41: { desc: '歳を重ねるほど輝きを増す大器晩成型。若いうちの苦労も経験も、ぜんぶ未来の肥やしにしていく。', oshiHint: 'これからが本番の推し。長く推すほどリターンが大きい優良銘柄。' },
  42: { desc: '瞬発力だけでなく、踏ん張りがきく粘り強さも持つハンター。転んでも立ち上がる回復力はトップクラス。', oshiHint: '逆境からの復活劇が似合う推し。苦しい時期を越えた後の表情に注目。' },
  43: { desc: 'じっとしていられない行動派の虎。広いテリトリーを飛び回りながら、行く先々で信頼を勝ち取っていく。', oshiHint: '活動範囲がどんどん広がる推し。気づけば海外にいたりする。' },
  44: { desc: '内に燃える炎を持つ情熱家。クールな見た目とのギャップで、いざという時の熱さが人の心を動かす。', oshiHint: '普段クール、本番で熱い推し。スイッチが入る瞬間の目の変化を見て。' },
  45: { desc: '人を喜ばせるためなら労を惜しまないエンターテイナー。相手の「嬉しい」が自分の栄養になる人。', oshiHint: 'サービス精神が服を着て歩いている推し。期待の斜め上を返してくれる。' },
  46: { desc: '慎重で堅実、守りの達人。リスクを見極める冷静さがあり、大事なものを確実に守り抜く。', oshiHint: '安定感が売りの推し。危なげのなさは信頼の証、安心して推せる。' },
  47: { desc: '涙もろくて情に厚い、人間味の宝庫。喜怒哀楽を隠さない素直さが、周りの心の扉を開いていく。', oshiHint: 'もらい泣き常習犯の推し。感動の場面ではまず推しの顔を確認したい。' },
  48: { desc: '気高くエレガントなスピードスター。ただ速いだけじゃない、佇まいに宿る品格が別格のオーラを放つ。', oshiHint: '所作の美しさまで含めて完成されている推し。品格という言葉が似合う。' },
  49: { desc: '何事にも動じない、悠然とした大物感の持ち主。ゆったり構えているのに、要所は絶対に外さない。', oshiHint: '大物の風格が漂う推し。焦らない姿にこちらの心まで落ち着いてくる。' },
  50: { desc: '感受性が豊かで、喜びも悲しみも人一倍深く感じる人。その振れ幅の大きさが、表現の深みになる。', oshiHint: '感情の解像度が高い推し。演技や歌に乗る感情の量が明らかに違う。' },
  51: { desc: '群れない孤高の王。誰に何を言われても自分の信じる道を行く、その背中に人はついていきたくなる。', oshiHint: '我が道を行く推し。流行に迎合しない姿勢そのものがブランド。' },
  52: { desc: '生まれながらのリーダー。全体を見渡す視野と決断力で、チームを勝たせる方法を知っている。', oshiHint: 'リーダーの重責を背負う推し。決断の場面での表情は永久保存版。' },
  53: { desc: '喜怒哀楽が豊かで表情がころころ変わる、感情表現の天才。その素直な反応が周りを笑顔にする。', oshiHint: 'リアクションが最高な推し。表情集を作りたくなる衝動と戦うことになる。' },
  54: { desc: 'どんな状況でも「なんとかなる」と笑える楽天家。その明るさは根拠のない自信ではなく、実力の裏付けつき。', oshiHint: 'ピンチでも笑っている推し。その笑顔に何度も救われることになる。' },
  55: { desc: 'エネルギーの総量が桁違いのパワフル系。仕事も遊びも全力投球で、周りを勢いよく巻き込んでいく。', oshiHint: '体力おばけの推し。フルスロットルのパフォーマンスを浴びてほしい。' },
  56: { desc: 'おしゃれで洗練されているのに、偉ぶらない親しみやすさが魅力。センスと謙虚さの奇跡的な両立。', oshiHint: 'ハイセンスなのに気さくな推し。ラフな姿とキメた姿の落差で二度おいしい。' },
  57: { desc: '熱く燃えるハートを持つ王。感情を隠さずぶつかっていく真剣さが、周りの本気を引き出していく。', oshiHint: '感情をまっすぐ出す推し。本気の涙や本気の笑顔に立ち会える確率が高い。' },
  58: { desc: '堂々とした振る舞いの裏に、繊細なガラスの心を隠し持つ。その二面性こそが、深みと色気の源泉。', oshiHint: '強がりと弱さが同居する推し。ふと見せる素顔に心を掴まれたら戻れない。' },
  59: { desc: '自由を何より大切にする、しなやかな自信家。縛られることを嫌うからこそ、自分の足で立つ強さがある。', oshiHint: '型にはまらない推し。予定調和を壊してくれる瞬間が最高のご褒美。' },
  60: { desc: '深い愛情で周りを包み込む、慈愛の人。厳しさの奥にある優しさに気づいたとき、本当の魅力がわかる。', oshiHint: '愛が深すぎる推し。後輩やファンへの言葉の端々に人間性がにじむ。' },
};
...
// ---- 役割ケミストリー（自分と推しの最強ロールから相性テキストを生成） ----
function getTopRole(profile) {
  return Object.entries(profile.roles).sort((a, b) => b[1] - a[1])[0][0];
}

function getRoleChemistry(myProfile, oshiProfile, oshiName) {
  const myTop = getTopRole(myProfile);
  const oshiTop = getTopRole(oshiProfile);
  const myR = ROLE_LABELS[myTop];
  const oshiR = ROLE_LABELS[oshiTop];

  if (myTop === oshiTop) {
    return `${oshiName}もあなたも、いちばんの強みは${oshiR.emoji}「${oshiR.name}」。同じ武器を持つ似た者同士だから、推しの行動の理由が手に取るようにわかるはず。「わかりみが深い」が止まらない組み合わせ。`;
  }
  return `${oshiName}の最強ロールは${oshiR.emoji}「${oshiR.name}」、あなたは${myR.emoji}「${myR.name}」。${oshiR.desc}と、${myR.desc}。違う武器を持つ二人だからこそ、あなたにしか見えない推しの一面がきっとある。`;
}
...
function generatePreciousText(members, groupName) {
  ...
  // 感動テキスト
  texts.push(`12のアニマル気質の視点で見ると、${name}のメンバーは「出会うべくして出会った」組み合わせ。それぞれが持つ個性が、グループになった瞬間に化学反応を起こし、1+1を何倍にもする。だからファンは「このグループが好き」ではなく「このグループじゃないとダメ」になる。それが、${name}が尊い理由。`);
